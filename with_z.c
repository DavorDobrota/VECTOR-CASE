...
//    }
    ...
    FP_TYPE M_12_unoptimized = calculate_mutual_inductance_near_unoptimized(data, precision, d, 6.0 * data.R_1, true);
    FP_TYPE M_12_1 = guess_best_inductance_near(data, precision, d, -0.5 * data.L_1, 6 * data.R_1, true, 1e-5);
