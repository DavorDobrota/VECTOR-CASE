...
def write_lookup_table_to_file(lookup_table, max_terms, near: bool):
    filename = "sum_lookup_table_near.h" if near else "sum_lookup_table_far.h"
...
if __name__ == '__main__':
    ...
    write_lookup_table_to_file(table_near, terms, True)

    table_far = generate_lookup_table_far(terms, terms, terms)
    write_lookup_table_to_file(table_far, terms, False)
